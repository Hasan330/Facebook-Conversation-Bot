goog.provide("among.Among");
goog.provide("among.Among$SII");
goog.provide("stemmer.Stemmer");
goog.provide("base-stemmer.BaseStemmer");
goog.provide("english-stemmer.EnglishStemmer");
(function () {
...
$__jsx_extend([EnglishStemmer], BaseStemmer);
...
EnglishStemmer.prototype.copy_from = EnglishStemmer.prototype.copy_from$LEnglishStemmer$;
...
lab0:
	while (lab0 === true) {
		...
		if (! BaseStemmer$eq_s$LBaseStemmer$IS(this, 1, "'")) {
			break lab0;
		}
		...
		lab4:
			...
			golab5:
				...
				lab6:
					while (lab6 === true) {
						lab6 = false;
						if (! BaseStemmer$in_grouping$LBaseStemmer$AIII(this, EnglishStemmer.g_v, 97, 121)) {
							break lab6;
						}
						this.bra = this.cursor;
						if (! BaseStemmer$eq_s$LBaseStemmer$IS(this, 1, "y")) {
...
EnglishStemmer.prototype.r_prelude = EnglishStemmer.prototype.r_prelude$;

function EnglishStemmer$r_prelude$LEnglishStemmer$($this) {
	var v_1;
	var v_2;
	var v_3;
	var v_4;
...
EnglishStemmer.r_prelude$LEnglishStemmer$ = EnglishStemmer$r_prelude$LEnglishStemmer$;
...
lab0:
	...
	lab1:
		...
		lab2:
			while (lab2 === true) {
				lab2 = false;
				if (BaseStemmer$find_among$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_0, 3) === 0) {
					break lab2;
				}
				break lab1;
			}
		...
		golab5:
			...
			lab6:
				while (lab6 === true) {
					lab6 = false;
					if (! BaseStemmer$out_grouping$LBaseStemmer$AIII(this, EnglishStemmer.g_v, 97, 121)) {
						break lab6;
					}
					break golab5;
				}
...
EnglishStemmer.prototype.r_mark_regions = EnglishStemmer.prototype.r_mark_regions$;

function EnglishStemmer$r_mark_regions$LEnglishStemmer$($this) {
	var v_1;
	var v_2;
	var lab0;
	var lab1;
...
EnglishStemmer.r_mark_regions$LEnglishStemmer$ = EnglishStemmer$r_mark_regions$LEnglishStemmer$;
...
lab0:
	...
	lab1:
		while (lab1 === true) {
			lab1 = false;
			if (! BaseStemmer$out_grouping_b$LBaseStemmer$AIII(this, EnglishStemmer.g_v_WXY, 89, 121)) {
				break lab1;
			}
			if (! BaseStemmer$in_grouping_b$LBaseStemmer$AIII(this, EnglishStemmer.g_v, 97, 121)) {
				break lab1;
			}
			if (! BaseStemmer$out_grouping_b$LBaseStemmer$AIII(this, EnglishStemmer.g_v, 97, 121)) {
				break lab1;
			}
			break lab0;
		}
...
EnglishStemmer.prototype.r_shortv = EnglishStemmer.prototype.r_shortv$;

function EnglishStemmer$r_shortv$LEnglishStemmer$($this) {
	var v_1;
	var lab0;
	var lab1;
	lab0 = true;
...
EnglishStemmer.r_shortv$LEnglishStemmer$ = EnglishStemmer$r_shortv$LEnglishStemmer$;

EnglishStemmer.prototype.r_R1$ = function () {
	return (! (this.I_p1 <= this.cursor) ? false : true);
};

EnglishStemmer.prototype.r_R1 = EnglishStemmer.prototype.r_R1$;

function EnglishStemmer$r_R1$LEnglishStemmer$($this) {
	return (! ($this.I_p1 <= $this.cursor) ? false : true);
};

EnglishStemmer.r_R1$LEnglishStemmer$ = EnglishStemmer$r_R1$LEnglishStemmer$;

EnglishStemmer.prototype.r_R2$ = function () {
	return (! (this.I_p2 <= this.cursor) ? false : true);
};

EnglishStemmer.prototype.r_R2 = EnglishStemmer.prototype.r_R2$;

function EnglishStemmer$r_R2$LEnglishStemmer$($this) {
	return (! ($this.I_p2 <= $this.cursor) ? false : true);
};

EnglishStemmer.r_R2$LEnglishStemmer$ = EnglishStemmer$r_R2$LEnglishStemmer$;
...
lab0:
	while (lab0 === true) {
		lab0 = false;
		this.ket = this.cursor;
		among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_1, 3);
		if (among_var === 0) {
			this.cursor = ((this.limit - v_1) | 0);
			break lab0;
		}
	...
	this.ket = this.cursor;
	among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_2, 6);
	if (among_var === 0) {
		return false;
	}
	this.bra = this.cursor;
	...
	lab1:
		...
		lab2:
			...
			if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "ie")) {
				return false;
			}
		}
		break;
...
EnglishStemmer.prototype.r_Step_1a = EnglishStemmer.prototype.r_Step_1a$;

function EnglishStemmer$r_Step_1a$LEnglishStemmer$($this) {
	var among_var;
	var v_1;
	var v_2;
	var lab0;
...
EnglishStemmer.r_Step_1a$LEnglishStemmer$ = EnglishStemmer$r_Step_1a$LEnglishStemmer$;
...
EnglishStemmer.prototype.r_Step_1b$ = function () {
	...
	var $__jsx_postinc_t;
	this.ket = this.cursor;
	among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_4, 6);
	if (among_var === 0) {
		return false;
	}
	this.bra = this.cursor;
	...
	golab0:
		...
		among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_3, 13);
		if (among_var === 0) {
			return false;
		}
		...
		case 3:
			...
			if (! EnglishStemmer$r_shortv$LEnglishStemmer$(this)) {
				return false;
			}
...
EnglishStemmer.prototype.r_Step_1b = EnglishStemmer.prototype.r_Step_1b$;

function EnglishStemmer$r_Step_1b$LEnglishStemmer$($this) {
	var among_var;
	var v_1;
	var v_3;
	var v_4;
...
EnglishStemmer.r_Step_1b$LEnglishStemmer$ = EnglishStemmer$r_Step_1b$LEnglishStemmer$;
...
EnglishStemmer.prototype.r_Step_1c = EnglishStemmer.prototype.r_Step_1c$;

function EnglishStemmer$r_Step_1c$LEnglishStemmer$($this) {
	var v_1;
	var v_2;
	var lab0;
	var lab1;
...
EnglishStemmer.r_Step_1c$LEnglishStemmer$ = EnglishStemmer$r_Step_1c$LEnglishStemmer$;

EnglishStemmer.prototype.r_Step_2$ = function () {
	var among_var;
	var cursor$0;
	this.ket = this.cursor;
	among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_5, 24);
	if (among_var === 0) {
		return false;
	}
	...
	case 13:
		...
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "og")) {
			return false;
		}
		break;
	case 14:
		...
		break;
	case 15:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "less")) {
			return false;
		}
		break;
	case 16:
		if (! BaseStemmer$in_grouping_b$LBaseStemmer$AIII(this, EnglishStemmer.g_valid_LI, 99, 116)) {
			return false;
		}
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "")) {
			return false;
...
EnglishStemmer.prototype.r_Step_2 = EnglishStemmer.prototype.r_Step_2$;

function EnglishStemmer$r_Step_2$LEnglishStemmer$($this) {
	var among_var;
	var cursor$0;
	$this.ket = $this.cursor;
	among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I($this, EnglishStemmer.a_5, 24);
...
EnglishStemmer.r_Step_2$LEnglishStemmer$ = EnglishStemmer$r_Step_2$LEnglishStemmer$;

EnglishStemmer.prototype.r_Step_3$ = function () {
	var among_var;
	var cursor$0;
	this.ket = this.cursor;
	among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_6, 9);
	if (among_var === 0) {
		return false;
	}
	this.bra = cursor$0 = this.cursor;
...
EnglishStemmer.prototype.r_Step_3 = EnglishStemmer.prototype.r_Step_3$;

function EnglishStemmer$r_Step_3$LEnglishStemmer$($this) {
	var among_var;
	var cursor$0;
	$this.ket = $this.cursor;
	among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I($this, EnglishStemmer.a_6, 9);
...
EnglishStemmer.r_Step_3$LEnglishStemmer$ = EnglishStemmer$r_Step_3$LEnglishStemmer$;
...
EnglishStemmer.prototype.r_Step_4$ = function () {
	...
	var cursor$0;
	this.ket = this.cursor;
	among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_7, 18);
	if (among_var === 0) {
		return false;
	}
	this.bra = cursor$0 = this.cursor;
...
EnglishStemmer.prototype.r_Step_4 = EnglishStemmer.prototype.r_Step_4$;

function EnglishStemmer$r_Step_4$LEnglishStemmer$($this) {
	var among_var;
	var v_1;
	var lab0;
	var lab1;
...
EnglishStemmer.r_Step_4$LEnglishStemmer$ = EnglishStemmer$r_Step_4$LEnglishStemmer$;
...
EnglishStemmer.prototype.r_Step_5$ = function () {
	...
	var cursor$0;
	this.ket = this.cursor;
	among_var = BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_8, 2);
	if (among_var === 0) {
		return false;
	}
	this.bra = this.cursor;
...
EnglishStemmer.prototype.r_Step_5 = EnglishStemmer.prototype.r_Step_5$;

function EnglishStemmer$r_Step_5$LEnglishStemmer$($this) {
	var among_var;
	var v_1;
	var v_2;
	var lab0;
...
EnglishStemmer.r_Step_5$LEnglishStemmer$ = EnglishStemmer$r_Step_5$LEnglishStemmer$;

EnglishStemmer.prototype.r_exception2$ = function () {
	var cursor$0;
	this.ket = this.cursor;
	if (BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_9, 8) === 0) {
		return false;
	}
	this.bra = cursor$0 = this.cursor;
...
EnglishStemmer.prototype.r_exception2 = EnglishStemmer.prototype.r_exception2$;

function EnglishStemmer$r_exception2$LEnglishStemmer$($this) {
	var cursor$0;
	$this.ket = $this.cursor;
	if (BaseStemmer$find_among_b$LBaseStemmer$ALAmong$I($this, EnglishStemmer.a_9, 8) === 0) {
		return false;
...
EnglishStemmer.r_exception2$LEnglishStemmer$ = EnglishStemmer$r_exception2$LEnglishStemmer$;

EnglishStemmer.prototype.r_exception1$ = function () {
	var among_var;
	var cursor$0;
	this.bra = this.cursor;
	among_var = BaseStemmer$find_among$LBaseStemmer$ALAmong$I(this, EnglishStemmer.a_10, 18);
	if (among_var === 0) {
		return false;
	}
	...
	case 0:
		return false;
	case 1:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "ski")) {
			return false;
		}
		break;
	case 2:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "sky")) {
			return false;
		}
		break;
	case 3:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "die")) {
			return false;
		}
		break;
	case 4:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "lie")) {
			return false;
		}
		break;
	case 5:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "tie")) {
			return false;
		}
		break;
	case 6:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "idl")) {
			return false;
		}
		break;
	case 7:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "gentl")) {
			return false;
		}
		break;
	case 8:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "ugli")) {
			return false;
		}
		break;
	case 9:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "earli")) {
			return false;
		}
		break;
	case 10:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "onli")) {
			return false;
		}
		break;
	case 11:
		if (! BaseStemmer$slice_from$LBaseStemmer$S(this, "singl")) {
			return false;
		}
		break;
	}
...
EnglishStemmer.prototype.r_exception1 = EnglishStemmer.prototype.r_exception1$;

function EnglishStemmer$r_exception1$LEnglishStemmer$($this) {
	var among_var;
	var cursor$0;
	$this.bra = $this.cursor;
	among_var = BaseStemmer$find_among$LBaseStemmer$ALAmong$I($this, EnglishStemmer.a_10, 18);
...
EnglishStemmer.r_exception1$LEnglishStemmer$ = EnglishStemmer$r_exception1$LEnglishStemmer$;
...
EnglishStemmer.prototype.r_postlude = EnglishStemmer.prototype.r_postlude$;

function EnglishStemmer$r_postlude$LEnglishStemmer$($this) {
	var v_1;
	var v_2;
	var lab1;
	var lab3;
...
EnglishStemmer.r_postlude$LEnglishStemmer$ = EnglishStemmer$r_postlude$LEnglishStemmer$;
...
lab0:
	...
	lab1:
		while (lab1 === true) {
			lab1 = false;
			if (! EnglishStemmer$r_exception1$LEnglishStemmer$(this)) {
				break lab1;
			}
			break lab0;
		}
	...
	lab4:
		while (lab4 === true) {
			lab4 = false;
			if (! EnglishStemmer$r_prelude$LEnglishStemmer$(this)) {
				break lab4;
			}
		}
	...
	lab5:
		while (lab5 === true) {
			lab5 = false;
			if (! EnglishStemmer$r_mark_regions$LEnglishStemmer$(this)) {
				break lab5;
			}
		}
		...
		v_5 = ((limit$0 - cursor$3) | 0);
		lab6 = true;
	lab6:
		while (lab6 === true) {
			lab6 = false;
			if (! EnglishStemmer$r_Step_1a$LEnglishStemmer$(this)) {
				break lab6;
			}
		}
	...
	lab7:
		...
		lab8:
			while (lab8 === true) {
				lab8 = false;
				if (! EnglishStemmer$r_exception2$LEnglishStemmer$(this)) {
					break lab8;
				}
				break lab7;
			}
			cursor$4 = this.cursor = (((limit$1 = this.limit) - v_6) | 0);
			v_7 = ((limit$1 - cursor$4) | 0);
			lab9 = true;
		lab9:
			while (lab9 === true) {
				lab9 = false;
				if (! EnglishStemmer$r_Step_1b$LEnglishStemmer$(this)) {
					break lab9;
				}
			}
			cursor$5 = this.cursor = (((limit$2 = this.limit) - v_7) | 0);
			v_8 = ((limit$2 - cursor$5) | 0);
			lab10 = true;
		lab10:
			while (lab10 === true) {
				lab10 = false;
				if (! EnglishStemmer$r_Step_1c$LEnglishStemmer$(this)) {
					break lab10;
				}
			}
			cursor$6 = this.cursor = (((limit$3 = this.limit) - v_8) | 0);
			v_9 = ((limit$3 - cursor$6) | 0);
			lab11 = true;
		lab11:
			while (lab11 === true) {
				lab11 = false;
				if (! EnglishStemmer$r_Step_2$LEnglishStemmer$(this)) {
					break lab11;
				}
			}
			cursor$7 = this.cursor = (((limit$4 = this.limit) - v_9) | 0);
			v_10 = ((limit$4 - cursor$7) | 0);
			lab12 = true;
		lab12:
			while (lab12 === true) {
				lab12 = false;
				if (! EnglishStemmer$r_Step_3$LEnglishStemmer$(this)) {
					break lab12;
				}
			}
			cursor$8 = this.cursor = (((limit$5 = this.limit) - v_10) | 0);
			v_11 = ((limit$5 - cursor$8) | 0);
			lab13 = true;
		lab13:
			while (lab13 === true) {
				lab13 = false;
				if (! EnglishStemmer$r_Step_4$LEnglishStemmer$(this)) {
					break lab13;
				}
			}
			cursor$9 = this.cursor = (((limit$6 = this.limit) - v_11) | 0);
			v_12 = ((limit$6 - cursor$9) | 0);
			lab14 = true;
		lab14:
			while (lab14 === true) {
				lab14 = false;
				if (! EnglishStemmer$r_Step_5$LEnglishStemmer$(this)) {
					break lab14;
				}
			}
	...
	lab15:
		while (lab15 === true) {
			lab15 = false;
			if (! EnglishStemmer$r_postlude$LEnglishStemmer$(this)) {
				break lab15;
			}
		}
		this.cursor = v_13;
...
EnglishStemmer.prototype.stem = EnglishStemmer.prototype.stem$;

EnglishStemmer.prototype.equals$X = function (o) {
	return o instanceof EnglishStemmer;
};

EnglishStemmer.prototype.equals = EnglishStemmer.prototype.equals$X;

function EnglishStemmer$equals$LEnglishStemmer$X($this, o) {
	return o instanceof EnglishStemmer;
};

EnglishStemmer.equals$LEnglishStemmer$X = EnglishStemmer$equals$LEnglishStemmer$X;
...
EnglishStemmer.prototype.hashCode = EnglishStemmer.prototype.hashCode$;

function EnglishStemmer$hashCode$LEnglishStemmer$($this) {
	var classname;
	var hash;
	var i;
	var char;
...
EnglishStemmer.hashCode$LEnglishStemmer$ = EnglishStemmer$hashCode$LEnglishStemmer$;
...
$__jsx_lazy_init(EnglishStemmer, "a_0", function () {
	return [ new Among("arsen", -1, -1), new Among("commun", -1, -1), new Among("gener", -1, -1) ];
});
$__jsx_lazy_init(EnglishStemmer, "a_1", function () {
	return [ new Among("'", -1, 1), new Among("'s'", 0, 1), new Among("'s", -1, 1) ];
});
$__jsx_lazy_init(EnglishStemmer, "a_2", function () {
	return [ new Among("ied", -1, 2), new Among("s", -1, 3), new Among("ies", 1, 2), new Among("sses", 1, 1), new Among("ss", 1, -1), new Among("us", 1, -1) ];
});
...
$__jsx_lazy_init(EnglishStemmer, "a_4", function () {
	return [ new Among("ed", -1, 2), new Among("eed", 0, 1), new Among("ing", -1, 2), new Among("edly", -1, 2), new Among("eedly", 3, 1), new Among("ingly", -1, 2) ];
});
$__jsx_lazy_init(EnglishStemmer, "a_5", function () {
	return [ new Among("anci", -1, 3), new Among("enci", -1, 2), new Among("ogi", -1, 13), new Among("li", -1, 16), new Among("bli", 3, 12), new Among("abli", 4, 4), new Among("alli", 3, 8), new Among("fulli", 3, 14), new Among("lessli", 3, 15), new Among("ousli", 3, 10), new Among("entli", 3, 5), new Among("aliti", -1, 8), new Among("biliti", -1, 12), new Among("iviti", -1, 11), new Among("tional", -1, 1), new Among("ational", 14, 7), new Among("alism", -1, 8), new Among("ation", -1, 7), new Among("ization", 17, 6), new Among("izer", -1, 6), new Among("ator", -1, 7), new Among("iveness", -1, 11), new Among("fulness", -1, 9), new Among("ousness", -1, 10) ];
});
$__jsx_lazy_init(EnglishStemmer, "a_6", function () {
	return [ new Among("icate", -1, 4), new Among("ative", -1, 6), new Among("alize", -1, 3), new Among("iciti", -1, 4), new Among("ical", -1, 4), new Among("tional", -1, 1), new Among("ational", 5, 2), new Among("ful", -1, 5), new Among("ness", -1, 5) ];
});
$__jsx_lazy_init(EnglishStemmer, "a_7", function () {
	return [ new Among("ic", -1, 1), new Among("ance", -1, 1), new Among("ence", -1, 1), new Among("able", -1, 1), new Among("ible", -1, 1), new Among("ate", -1, 1), new Among("ive", -1, 1), new Among("ize", -1, 1), new Among("iti", -1, 1), new Among("al", -1, 1), new Among("ism", -1, 1), new Among("ion", -1, 2), new Among("er", -1, 1), new Among("ous", -1, 1), new Among("ant", -1, 1), new Among("ent", -1, 1), new Among("ment", 15, 1), new Among("ement", 16, 1) ];
});
$__jsx_lazy_init(EnglishStemmer, "a_8", function () {
	return [ new Among("e", -1, 1), new Among("l", -1, 2) ];
});
$__jsx_lazy_init(EnglishStemmer, "a_9", function () {
	return [ new Among("succeed", -1, -1), new Among("proceed", -1, -1), new Among("exceed", -1, -1), new Among("canning", -1, -1), new Among("inning", -1, -1), new Among("earring", -1, -1), new Among("herring", -1, -1), new Among("outing", -1, -1) ];
});
$__jsx_lazy_init(EnglishStemmer, "a_10", function () {
	return [ new Among("andes", -1, -1), new Among("atlas", -1, -1), new Among("bias", -1, -1), new Among("cosmos", -1, -1), new Among("dying", -1, 3), new Among("early", -1, 9), new Among("gently", -1, 7), new Among("howe", -1, -1), new Among("idly", -1, 6), new Among("lying", -1, 4), new Among("news", -1, -1), new Among("only", -1, 10), new Among("singly", -1, 11), new Among("skies", -1, 2), new Among("skis", -1, 1), new Among("sky", -1, -1), new Among("tying", -1, 5), new Among("ugly", -1, 8) ];
});
...
among.Among = JSX.require("src/among.jsx").Among;
among.Among$SII = JSX.require("src/among.jsx").Among$SII;
stemmer.Stemmer = JSX.require("src/stemmer.jsx").Stemmer;
base-stemmer.BaseStemmer = JSX.require("src/base-stemmer.jsx").BaseStemmer;
english-stemmer.EnglishStemmer = JSX.require("src/english-stemmer.jsx").EnglishStemmer;
})();
